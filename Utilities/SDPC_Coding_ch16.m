...
function [y_q, rate,coef] = SDPC_Coding_ch16(y, quantizer_bitdepth, num_rows,num_cols, Phi,trial)
...
[yq, y_q, y_index,coef] = SDPC_Encode_ch16(y,q,DC_Measure,num_rows,block_size);
